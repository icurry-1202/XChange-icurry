 ...
 * @author buxianguan
 */
public class BinanceCoinFutureBaseService extends BaseResilientExchangeService<BinanceCoinFutureExchange> {

    protected final Logger LOG = LoggerFactory.getLogger(getClass());

    protected final String apiKey;
    protected final BinanceCoinFutureAuthenticated binance;
    protected final ParamsDigest signatureCreator;

    protected BinanceCoinFutureBaseService(
