 ...
 * @author buxianguan
 */
public class BinanceCoinFutureTimestampFactory implements SynchronizedValueFactory<Long> {

    private static final Logger LOG = LoggerFactory.getLogger(BinanceCoinFutureTimestampFactory.class);

    private final BinanceCoinFuture binance;
    ...
    public BinanceCoinFutureTimestampFactory(
            BinanceCoinFuture binance,
