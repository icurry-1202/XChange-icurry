 ...
 * @author buxianguan
 */
public class BinanceUsdFutureTimestampFactory implements SynchronizedValueFactory<Long> {

    private static final Logger LOG = LoggerFactory.getLogger(BinanceUsdFutureTimestampFactory.class);

    private final BinanceUsdFuture binance;
    ...
    public BinanceUsdFutureTimestampFactory(
