...
public interface HuobiFutureLinearSwap {
    ...
    HuobiResultV3<List<HuobiContractInfo>> getLinearSwapContractInfo(
            ...
            @QueryParam("business_type") String businessType) throws IOException;

    @GET
    @Path("linear-swap-api/v1/swap_funding_rate")
    HuobiResultV3<HuobiFundingRate> getLinearSwapFundingRate(
            @QueryParam("contract_code") String contractCode) throws IOException;

    @GET
    @Path("linear-swap-api/v1/swap_historical_funding_rate")
    HuobiResultV3<HuobiHistoricalFundingRateResult> getLinearSwapHistoricalFundingRate(
            @QueryParam("contract_code") String contractCode,
            @QueryParam("page_index") String pageIndex,
    ...
    HuobiResultV3<List<HuobiFutureAccount>> getLinearSwapCrossAccountInfo(
            @QueryParam("margin_account") String marginAccount,
            @QueryParam("AccessKeyId") String apiKey,
            @QueryParam("SignatureMethod") String signatureMethod,
            @QueryParam("SignatureVersion") int SignatureVersion,
            @QueryParam("Timestamp") String nonce,
    ...
    HuobiResultV3<List<HuobiFuturePosition>> getLinearSwapCrossPositionInfo(
            @QueryParam("contract_code") String contractCode,
            @QueryParam("pair") String pair,
            @QueryParam("contract_type") String contractType,
            @QueryParam("AccessKeyId") String apiKey,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    HuobiResultV3<HuobiFutureHisOrderResult> getLinearSwapHisOrders(
            @QueryParam("contract_code") String contractCode,
            @QueryParam("trade_type") Integer tradeType,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    HuobiResultV3<HuobiFutureHisOrderResult> getLinearSwapCrossHisOrders(
            @QueryParam("contract_code") String contractCode,
            @QueryParam("pair") String pair,
            @QueryParam("trade_type") Integer tradeType,
            @QueryParam("type") Integer type,
