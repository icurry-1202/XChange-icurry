...
import org.knowm.xchange.huobi.future.HuobiFuture;
...
public class HuobiFutureBaseService extends BaseExchangeService implements BaseService {
  ...
  protected HuobiFuture huobi;
  protected ParamsDigest signatureCreator;

  public HuobiFutureBaseService(Exchange exchange) {
    super(exchange);
    huobi =
        ExchangeRestProxyBuilder.forInterface(HuobiFuture.class, exchange.getExchangeSpecification())
            .build();
    signatureCreator =
