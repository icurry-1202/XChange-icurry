...
public interface HuobiFutureSwap {
    ...
    HuobiResultV3<HuobiFundingRate> getSwapFundingRate(
            @QueryParam("contract_code") String contractCode)
            throws IOException;

    @GET
    @Path("swap-api/v1/swap_historical_funding_rate")
    HuobiResultV3<HuobiHistoricalFundingRateResult> getSwapHistoricalFundingRate(
            @QueryParam("contract_code") String contractCode,
    ...
    HuobiResultV3<List<HuobiBalanceValuation>> getSwapBalanceValuation(
    ...
    HuobiResultV3<List<HuobiBalanceValuation>> getLinearSwapBalanceValuation(
            @QueryParam("valuation_asset") String valuationAsset,
            @QueryParam("AccessKeyId") String apiKey,
            @QueryParam("SignatureMethod") String signatureMethod,
            @QueryParam("SignatureVersion") int SignatureVersion,
    ...
    @Consumes(MediaType.APPLICATION_JSON)
    HuobiResultV3<HuobiFutureHisOrderResult> getSwapHisOrders(
            @QueryParam("contract_code") String contractCode,
            @QueryParam("trade_type") Integer tradeType,
